...
namespace Clases_KioPlus.Migrations
{
    ...
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CuentasCorrientesClientes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    MontoAdeudado = table.Column<double>(type: "float", nullable: false),
                    Estado = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CuentasCorrientesClientes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MontoTotal = table.Column<double>(type: "float", nullable: false),
                    CuentaCorrienteClienteId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ventas_CuentasCorrientesClientes_CuentaCorrienteClienteId",
                        column: x => x.CuentaCorrienteClienteId,
                        principalTable: "CuentasCorrientesClientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DetallesCompras_Compras_CompraProveedorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallesCompras_CompraProveedorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ventas_CuentaCorrienteClienteId",
                table: "Ventas",
